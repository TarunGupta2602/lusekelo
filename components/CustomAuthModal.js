...
export default function CustomAuthModal({ open, onClose }) {
  ...
  return (
    <>
      ...
      `}</style>
      <div
        className="auth-modal-overlay fixed inset-0 z-[1000] flex items-center justify-center pointer-events-none transition-all duration-300"
      >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <label htmlFor="terms" className="text-gray-300 text-sm">
                      I agree to the{" "}
                      <a href="/terms" className="underline text-[#bdeb6d]">
                        Terms & Conditions
                      </a>
                    </label>
                  </div>

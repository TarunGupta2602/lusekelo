...
export default function VendorLogin() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-blue-200 to-blue-300 p-2 sm:p-4">
      <div className="relative w-full max-w-md p-6 sm:p-8 rounded-2xl shadow-2xl bg-white bg-opacity-90 backdrop-blur-lg border border-blue-200">

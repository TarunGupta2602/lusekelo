// app/ShopContent.js (Client Component)
"use client";
...
const ShopContent = ({ stores }) => {
  const [showAll, setShowAll] = useState(false);

  // If stores are not provided (unlikely since it's passed from Server Component), show loader
  if (!stores) {
...
// Use dynamic import to prevent hydration issues (optional, can be removed if not needed)
